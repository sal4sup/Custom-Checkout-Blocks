...
class Shipping_Workshop_Extend_Store_Endpoint {
	...
	public static function extend_checkout_schema() {
		return [
			...
			'tshirtTitle' => [
				'description' => 'T-shirt title from extra workshop block',
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				'arg_options' => [
			...
			'tshirtDesc' => [
				'description' => 'T-shirt Description from extra workshop block',
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				'arg_options' => [
			...
			'tshirtSize' => [
				'description' => 'T-shirt Size from extra workshop block',
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				'arg_options' => [
			...
			'tshirtColor' => [
				'description' => 'T-shirt Color from extra workshop block',
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				'arg_options' => [
